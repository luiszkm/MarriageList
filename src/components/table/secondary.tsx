...
export function TableSecondary({tasks, ...props}:ProductsProps) {
  ...
  return (
    <div className="relative w-full max-w-3xl  overflow-auto"{...props}>
      <Table className="">
        <TableCaption>Lista de moveis </TableCaption>
        <TableHeader>
          <TableRow>
